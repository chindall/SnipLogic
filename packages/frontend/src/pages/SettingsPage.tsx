...
export default function SettingsPage() {
  ...
  // Auto-select first shared workspace
          ...
          <div className={styles.header}>
            <div className={styles.headerLeft}>
              ...
              <div>
                ...
                <p className={styles.subtitle}>Manage variables and preferences</p>
              </div>
            </div>
          </div>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.tabs}>
                ...
                >
                  My Variables
                  {userVars.length > 0 && (
                    <span className={styles.tabBadge}>{userVars.length}</span>
                  )}
                </button>
                <button
                ...
                >
                  ...
                  {workspaceVars.length > 0 && (
                    <span className={styles.tabBadge}>{workspaceVars.length}</span>
                  )}
                </button>
              </div>
            ...
            <section className={styles.section}>
              <div className={styles.sectionHeader}>
                <div>
                  ...
                  <p className={styles.sectionDesc}>
                    These are resolved automatically by the browser extension at expansion time — no setup needed.
                  </p>
                </div>
              </div>
